...
const PLANS = [
  {
    ...
    features: ['100 минут практики', 'Всё оборудование включено', 'Знакомство с методом'],
    highlight: false,
  },
  {
    name: 'Абонемент',
    ...
    features: ['5 занятий в удобные дни', 'Заморозка на болезнь', 'Место в группе за вами'],
    highlight: true,
  },
  {
    name: 'Корпоратив',
